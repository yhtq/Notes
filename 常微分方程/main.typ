...
= 微分方程的解理论
  == Peano 定理
    ...
    #proof[ 
      ...
      在引理中取 $E = QQ inter I$，它是 $I$ 的稠密子集，因此结论成立
    ]
  ...
  == 包络
    ...
    #proof[
      任取 $(x_0, y_0) in Gamma inter k_c$，则首先第一个方程当然成立\
...
= 幂级数解法
  ...
  == 广义幂级数 
    ...
    #theorem[][
      ...
      y'' + p(x) y' + q(x) y = 0
      $
      其中 $p, q$ 可能以 $0$ 为奇点，但 $x p, x^2 q$ 都在 $0$ 处解析且不全为零，则它在 $0$ 附近有广义幂级数解
    ]
    #proof[
      方程等价于：
      $
